...
import styles from '../../styles/components/HomeLanguageSelector.module.css';
...
interface HomeLanguageSelectorProps {
  value: string;
  onChange: (languageCode: string) => void;
}

export default function HomeLanguageSelector({ value, onChange }: HomeLanguageSelectorProps) {
  ...
  return (
    <div className={styles.homeLanguageSelector} ref={dropdownRef}>
      <button
        ...
        <ul className={styles.dropdown} role="listbox">
          {languages.map((language) => (
            <li key={language.code}>
              <button
                className={`${styles.option} ${value === language.code ? styles.active : ''}`}
